...
class generic_tree {
    ...
    height_of_tree( node){
        ...
        // let height= -1 //================= in case of edges =================
        let height= 0 //================= in case of nodes =================

        for (let item of node.children){
            let max_child= this.height_of_tree(item)
            height=Math.max(height,max_child)
        }
        height+=1 
        return height;
    }
...
const height=tree.height_of_tree(tree.root)
console.log(height);